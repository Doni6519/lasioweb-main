  ...
  return (
    <div className="text-sm">
      ...
      <section className="our_portfolio py-5 text-white">
        ...
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-5/6">
          <div className="bg-white h-60 rounded"></div>
          <div className="bg-white h-60 rounded"></div>
          <div className="bg-white h-60 rounded hidden md:block"></div>
          <div className="bg-white h-60 rounded hidden md:block"></div>
        </div>
      </section>
    </div>
